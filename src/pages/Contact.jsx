            ...
            <div className="grid gap-12 lg:grid-cols-2">
                ...
                <div className="rounded-3xl border border-white/10 bg-dark-800 p-8 shadow-2xl">
                    <form className="space-y-6">
                        ...
                        <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-accent-blue py-4 font-bold text-black transition-all hover:scale-[1.02] active:scale-95 group">
                            Send Message <Send size={18} className="translate-x-0 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                        </button>
                    </form>
                </div>
            </div>
