    ...
    return (
        <div className="w-full max-w-full py-12">
            ...
            >
                ...
                <div className="grid gap-10 lg:grid-cols-2 border-b border-white/10 pb-12 mb-12">
                    {/* School days */}
                    <div className="space-y-4 p-6 rounded-2xl bg-white/[0.01] border border-white/5 hover:border-accent-blue/20 transition-all">
                        <div className="flex items-center gap-3 text-accent-blue mb-2">
                            <BookOpen size={24} />
                            <h3 className="text-xl font-black">My Journey</h3>
                        </div>
                        <p className="text-white/60 leading-relaxed font-medium text-sm md:text-base">
                            My interest in technology began during my school days at Bharathiyar Matriculation Higher Secondary School. While studying, I became curious about computers, software, and how technology could solve real-world problems.
                        </p>
                        <p className="text-white/60 leading-relaxed font-medium text-sm md:text-base">
                            As I explored programming and web development, I discovered my passion for creating applications that make people's lives easier. This curiosity eventually inspired me to pursue Computer Science and Engineering and continue learning new technologies every day.
                        </p>
                    </div>

                    {/* College days */}
                    <div className="space-y-4 p-6 rounded-2xl bg-white/[0.01] border border-white/5 hover:border-accent-purple/20 transition-all">
                        <div className="flex items-center gap-3 text-accent-purple mb-2">
                            <GraduationCap size={24} />
                            <h3 className="text-xl font-black">The College Chapter</h3>
                        </div>
                        <p className="text-white/60 leading-relaxed font-medium text-sm md:text-base">
                            Currently pursuing B.E. Computer Science and Engineering at Sri Eshwar College of Engineering.
                        </p>
                        <p className="text-white/60 leading-relaxed font-medium text-sm md:text-base">
                            College has introduced me to various areas of technology including programming, software development, databases, cloud computing, artificial intelligence, and software engineering principles.
                        </p>
                        <p className="text-white/60 leading-relaxed font-medium text-sm md:text-base">
                            Through classroom learning, self-study, hackathons, and project development, I have gained valuable technical and problem-solving skills that continue to shape my journey.
                        </p>
                    </div>
                </div>
                ...
                <div className="border-b border-white/10 pb-12 mb-12">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        {[
                            ...
                            <div key={proj.name} className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-white/10 hover:bg-white/[0.04] transition-all">
                ...
                <div className="grid gap-10 lg:grid-cols-12 border-b border-white/10 pb-12 mb-12">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 space-y-4">
                            ...
                            <p className="text-xs text-white/50">Every hackathon has taught me something valuable beyond coding: teamwork, communication, time pressure, and creativity.</p>
                ...
                <div className="border-b border-white/10 pb-12 mb-12">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {[
                            ...
                            <div key={cert.name} className="group relative p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-accent-blue/30 hover:bg-white/[0.05] transition-all flex flex-col justify-between">
                                <div>
